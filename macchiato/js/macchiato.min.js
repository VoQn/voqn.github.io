...
checker.marks={skipped:"\u2662",passed:"\u2713",faild:"\u2718"};checker.wrapQuote=function(a){return"string"===typeof a?'"'+a+'"':a+""};checker.logging=function(a,c){var b;checker.shouldRetry=!1;a.skipped?(b="skipped",c.skipped++):a.passed?(b="passed",c.passed++):(b="faild",c.failure++,checker.shouldRetry=!0);checker.current=checker.marks[b]+" ( "+map(checker.wrapQuote,a.arguments).join(", ")+" )";checker.why=a.reason;return checker};checker.run=function(a,c,b){a=c(a);return checker.logging(a,b)};
var ViewInterface=new Interface("ViewInterface","getTestCount standby clean putMsg putLog dump highlight".split(" ")),View=function(){},createView=function(a){var c=new View,b="";for(b in a)c[b]=a[b];Interface.ensureImplements(c,ViewInterface);return c},consoleView=function(){var a=[],c=0;return createView({getTestCount:function(){return 100},standby:function(){console.clear&&console.clear();a=[];c=0},clean:function(){a=[];c=0},putMsg:function(a){console.log(a)},putLog:function(b){a[c]=b;c++},dump:function(){0<
a.length&&console.log(a.join("\n"))},highlight:function(a,c){return c}})}(),htmlView=function(){var a=[],c=0;return createView({selectors:{counter_id:"test-count",messenger_id:"test-message",logger_id:"test-log"},setSelectors:function(a){var c=this.selectors,e="";for(e in c){if(void 0===a[e])throw Error("html-test-view need selector id :"+e+", but undefined");this.selectors[e]=a[e]}return this},getTestCount:function(){return parseInt(document.getElementById(this.selectors.counter_id).value,10)},standby:function(){a=
[];c=0},clean:function(){a=[]},putMsg:function(a){document.getElementById(this.selectors.messenger_id).innerHTML=a},putLog:function(b,d){a[c]=!d?b:htmlEscape(b);c++},dump:function(){document.getElementById(this.selectors.logger_id).innerHTML=a.join("<br>");a=[];c=0},highlight:function(a,c){return'<span class="'+(a?"passed":"failed")+'">'+c+"</span>"}})}(),Macchiato=function(){},macchiato=new Macchiato;macchiato.view_=consoleView;macchiato.suites_=[];
macchiato.quickcheck=function(a,c,b){for(var b=supplement(100,b),d=0,e=!1;d<b;d++)if(checker.run(d,a,score),checker.shouldRetry){macchiato.view_.putLog(checker.current,!0);checker.run(d+1,a,score);macchiato.view_.putLog(checker.current,!0);break}score.evaluate();e=score.ok;macchiato.view_.putLog(macchiato.view_.highlight(e,(c?c+" : ":"")+score.message));score.clear();return e};
macchiato.verbosecheck=function(a,c,b){for(var b=supplement(100,b),d=0,e=!1;d<b;d++)if(checker.run(d,a,score),macchiato.view_.putLog(checker.current,!0),checker.shouldRetry){checker.run(d+1,a,score);macchiato.view_.putLog(checker.current,!0);break}score.evaluate();e=score.ok;macchiato.view_.putLog(macchiato.view_.highlight(e,(c?c+" : ":"")+score.message));score.clear();return e};macchiato.setVerbose=function(a){macchiato.view_.verbose=a;return macchiato};
macchiato.setView=function(a){Interface.ensureImplements(a,ViewInterface);macchiato.view_=a;return macchiato};macchiato.stock=function(a){macchiato.suites_.push(a);return macchiato};
macchiato.taste=function(){var a=macchiato.view_.verbose?macchiato.verbosecheck:macchiato.quickcheck,c=!0,b=0,d=macchiato.view_.getTestCount(),e=macchiato.suites_.length,f=whatTimeIsNow();for(macchiato.view_.standby();b<e;b++)for(label_ in macchiato.suites_[b])c=a(macchiato.suites_[b][label_],label_,d)&&c;a=whatTimeIsNow();macchiato.view_.dump();b=whatTimeIsNow();macchiato.view_.putMsg((c?"Ok, All tests succeeded!!":"Oops! failed test exist...")+" ( testing: "+printTime(f,a)+", log rendering: "+printTime(a,
b)+" )");return macchiato};