...
(currentResult.passed=!1,currentResult.skipped=!0,currentResult.reason="Skipped: ("+d.join(", ")+")"):(currentResult.passed=e,currentResult.skipped=!1,currentResult.reason=e?"":"Falsible: ("+d.join(", ")+")");currentResult.arguments=d;return currentResult}},where=function(b,c){for(var a=0,d=b.length;a<d;a++)if(!b[a])return skippedTest;return c()},Score=function(){},score=new Score;score.ok=!1;score.passed=0;score.failure=0;score.skipped=0;score.message="Test has not run";
score.clear=function(){score.ok=!1;score.passed=0;score.skipped=0;score.failure=0;score.message="Test has not run";return score};score.evaluate=function(){score.ok=0===score.failure;score.message=(score.ok?"\u2713 OK, passed "+score.passed+"":"\u2718 Failed. after "+(score.passed+score.skipped))+" tests."+(0<score.skipped?" \u2662 skipped "+score.skipped+" cases":"");return score};var Seed=function(){},seed=new Seed;
seed.linear=function(b,c){var a=supplement(1,b,Math.max),d=supplement(0,c);return function(b){return a*b+d}};seed.quadratic=function(b,c,a){var d=supplement(1,b),e=supplement(0,c),g=supplement(0,a);return function(a){return d*a*a+e*a+g}};seed.exponent=function(b,c){var a=supplement(2,b,Math.max),d=supplement(1,c);return function(b){return Math.pow(a,Math.round(b*d))}};
seed.logarithm=function(b,c,a){var d=supplement(1,b),e=supplement(2,c,Math.max),g=supplement(0,a);return function(){return Math.log(value*d)/Math.log(e)+g}};var Combinator=function(){},combinator=new Combinator;combinator.sized=function(b){var c=seed.exponent(2,0.5);return function(a){a=c(a);return b(a)}};combinator.resize=function(b,c){return function(a){a=b(a);return c(a)}};
combinator.choose=function(b,c){var a=Math.min(b,c),d=Math.max(b,c),e;return Math.floor(b)===b&&Math.floor(c)===c?function(){return e=Math.floor(Math.random()*(d-a+1))+a}:function(){return e=Math.random()*(d-a+1)+a}};combinator.chooseNow=function(b,c){var a=Math.min(b,c),d=Math.max(b,c);return Math.floor(b)===b&&Math.floor(c)===c?a=Math.floor(Math.random()*(d-a+1))+a:a=Math.random()*(d-a+1)+a};combinator.elements=function(b){var c=combinator.choose(0,b.length-1);return function(){var a=c();return b[a]}};
combinator.oneOf=function(b){var c=combinator.choose(0,b.length-1);return function(a){var d=c();return b[d](a)}};combinator.listOf=function(b,c){var a=0,d=0,e=[],g=function(c){a=0;d=Math.random()*c;for(e=[];a<d;a++)e[a]=b(c);return e};return void 0===c?g:function(f){a=0;d=Math.random()*f;for(e=[];a<d;a++)e[a]=b(f);return e=c(e)}};combinator.listOf1=function(b){return function(c){var a=0;l_=Math.random()*c;length=1>l_?1:l_;for(result=[];a<length;a++)result[a]=b(c);return result}};
combinator.vectorOf=function(b,c){return function(){for(var a=0,d=[];a<b;a++)d[a]=c();return d}};combinator.frequency=function(b,c){var a=map(function(a){return a.fst},b),d=map(function(a){return a.snd},b),e=sumOf(a),g=combinator.choose(1,e),f=0,h=1,i=1,e=function(b){f=0;for(h=g();i=a[f];f++){if(h<i)return b=d[f](b);h-=i}return b=d[f-1](b)};return void 0===c?e:function(b){f=0;for(h=g();i=a[f];f++){if(h<i)return b=d[f](b),c(b);h-=i}b=d[f-1](b);return c(b)}};
var GenerateReference=function(){},generateReference=new GenerateReference;generateReference.register=function(b,c){var a=function(a,b){if("prototype"==a||"register"==a)throw Error("GenerateRefference."+a+" should not overwrite");generateReference[a]=b;return generateReference};2===arguments.length&&"string"===typeof b&&"function"===typeof c?a(b,c):each(flip(a),b);return this};
...
macchiato.taste=function(){var b=macchiato.view_,c=b.verbose?macchiato.verbosecheck:macchiato.quickcheck,a=!0,d=0,e=macchiato.suites_,g,f,h=(new Date).getTime();for(b.standby();g=e[d];d++)for(label in g)f=g[label],a=c(f,label)&&a;b.dump();b.putMsg((a?"Ok, All tests succeeded!!":"Oops! failed test exist...")+" ( "+function(a,b){var c=b-a;return 6E4<c?c/6E4+"min":1E3<c?c/1E3+"s":c+"ms"}(h,(new Date).getTime())+" )");return macchiato};
